...
class ExperimentPlateauOrMaxStepsStopper(Stopper):
    ...
    def __init__(self, metric, std=0.001, top=10, mode="min", patience=0, max_iters=20):
    ...
    def __call__(self, trial_id, result):
        ...
        # Stop if we reach max number of iterations
        if self._max_iters > self._total_iterations:
            return True
